---
name: static-to-react
description: 靜態網站轉 React 框架助手，協助將 HTML + CSS/SASS + vanilla JS 靜態網站轉換為現代 React 專案。用於：(1) 將完整靜態網站專案轉換為 Vite + React + TypeScript 專案，(2) 將單一 HTML 頁面或元件轉換為 React Component，(3) 審查已轉換的 React 程式碼品質。當使用者需要靜態網頁轉 React、HTML 轉 JSX 元件、CSS/SASS 轉 Tailwind/Styled Components、vanilla JS 轉 React Hooks、或建立 React 專案時觸發此技能。
---

# 靜態網站轉 React 助手

協助將靜態網站（HTML + CSS/SASS + vanilla JS）轉換為 React 框架專案。
...
3. **轉換結構**
   - HTML 頁面 → TanStack Router 路由檔（見 [routing.md](references/routing.md)）
   - 語意化區塊 → React 元件（見 [html-to-jsx.md](references/html-to-jsx.md)）
...
5. **轉換邏輯**
   - DOM 操作 → React 宣告式渲染（見 [js-to-react.md](references/js-to-react.md)）
   - 全域狀態 → Zustand（見 [state-management.md](references/state-management.md)）
   - API 呼叫 → TanStack Query（見 [server-state.md](references/server-state.md)）
   - 表單 → React Hook Form + Zod（見 [forms.md](references/forms.md)）
...
將單一 HTML 頁面或區塊轉換為 React 元件。

1. 分析 HTML 結構與 BEM class
2. 依 [html-to-jsx.md](references/html-to-jsx.md) 轉換語法
3. 依 [css-conversion.md](references/css-conversion.md) 轉換樣式
4. 依 [js-to-react.md](references/js-to-react.md) 轉換互動邏輯
5. 產出 TypeScript React 元件（含 Props 型別定義）
6. 撰寫元件測試

### 流程三：審查已轉換的程式碼

1. 檢查元件拆分是否合理（[html-to-jsx.md](references/html-to-jsx.md)）
...
| 文件                                                    | 用途                        | 載入時機                |
| ------------------------------------------------------- | --------------------------- | ----------------------- |
| [project-structure.md](references/project-structure.md) | React 專案結構規範          | 建立新專案、審查結構    |
| [html-to-jsx.md](references/html-to-jsx.md)             | HTML → JSX 元件拆分         | 轉換 HTML、拆分元件     |
| [css-conversion.md](references/css-conversion.md)       | CSS/SASS → Tailwind/SC/SASS | 轉換樣式                |
| [js-to-react.md](references/js-to-react.md)             | vanilla JS → React Hooks    | 轉換互動邏輯            |
...
| 文件                                                  | 用途                          | 載入時機      |
| ----------------------------------------------------- | ----------------------------- | ------------- |
| [routing.md](references/routing.md)                   | 多頁面 → TanStack Router      | 處理頁面路由  |
| [forms.md](references/forms.md)                       | 表單 → RHF + Zod              | 處理表單轉換  |
| [state-management.md](references/state-management.md) | 狀態管理 → Zustand            | 處理全域狀態  |
